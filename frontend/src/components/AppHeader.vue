...
<template>
  <header>
    <div class="container" style="display: flex; justify-content: space-between; align-items: center;">
      <div>
        <h1>🗄️ UniDB MCP</h1>
        <p style="opacity: 0.8;">Database Connection Manager</p>
      </div>
      <div class="header-right">
        <a
          href="https://github.com/mikespook/unidb-mcp-server"
          target="_blank"
          rel="noopener"
          class="btn-ghost"
          title="GitHub"
        ...
        <button class="btn-ghost" title="Change password" @click="$emit('changePassword')">
        ...
        <button class="btn-ghost" title="Access Management" @click="$emit('accessManagement')">
          <svg height="20" width="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/>
          </svg>
        </button>
        <button class="btn-ghost" title="Logout" @click="$emit('logout')">
          <svg height="20" width="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
